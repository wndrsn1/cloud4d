...
class UNet(nn.Module):
    def __init__(self, in_channels, out_channels, model_channels, resolution, num_blocks, attn_resolutions):
        super(UNet, self).__init__()
        self.out_channels = out_channels

        self.encoder = SongUNet(resolution, 
                                in_channels, 
                                out_channels,
        ...
        nn.init.xavier_uniform_(self.out.weight, 1)
